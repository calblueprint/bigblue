# Description:
#   Make sure that big blue knows our constitutiton.
#
# Dependencies:
#   
#
...
#
# Commands:
#   bigblue the constitution - Make sure big blue knows the constitution
#
# Notes:
#   DON'T DELETE THIS SCRIPT! ALL ROBAWTS MUST KNOW THE CONSTITUTION
#
# Author:
#   jayyr
...
2. We will not haze according to California State Law. We will not restrict membership based upon race, color, national origin, religion, sex, physical and mental disability, medical condition (cancer-related or genetic characteristics), ancestry, marital status, age, sexual orientation, citizenship or status as a covered veteran (special disabled veteran, Vietnam-era veteran or any other veteran who served on active duty during a war or in a campaign or expedition for which a campaign badge has been authorized).
...
3. The Vice President of Operations shall be responsible for obtaining facilities for meetings and activities
...
3. The Vice President of Projects shall, with the advice and consent of the Executive Committee, create
the membership and application process by the second week of the semester.
...
2. Every meeting shall have an agenda created by the meeting facilitator which shall be sent out to meeting
participants at least two days before the meeting.
...
2. The general membership shall meet every other week. A quorum is two-thirds of the general member- ship. Decisions requiring input from the general membership shall be made during the general membership meeting.
Section 3
...
Ammendments Ammendment 1
At least two weeks before the date of the election, the Executive Committee shall announce to all members the collection of all nominations for Executive Committee positions. A nomination is only invalidated if the
nominee refuses the nomination. The Executive Committee shall determine the procedures of nomination and campaign. Elections shall occur during general meeting only with a full quorum. On the date of the election, all members present at the general meeting shall name in distinct ballots the person voted for as President, the person voted for Vice President of Operations, the person voted for Vice President of Projects, the person voted for Vice President of Technology, and the person voted for Vice President of Finance and Marketing, each of which they shall sign and certify, and transmit sealed to the sitting President of Blueprint. The sitting President of Blueprint shall, in the presence of the general membership present at the meeting, open all the certificates and the votes shall then be counted; - Each position shall be given to the person having the most votes for that position, if such number be a majority; and if no person have such majority, then from the persons with the highest two numbers, the general membership shall vote by ballot. Each position shall be given to the person having the most votes for that position.
"]
module.exports = (robot) ->
  robot.respond /(what is )?the (constitution)/i, (msg) ->
    text = msg.message.text
    msg.send constitution
